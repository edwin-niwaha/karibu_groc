...
const form = document.querySelector('#userRegfrm');
...
const checkFirstname = () => {
    ...
    if (!isRequired(firstname)) {
        showError(firstnameEl, '⛔️ First name cannot be blank.');
...
const checkSurname = () => {
    ...
    if (!isRequired(surname)) {
        showError(surnameEL, '⛔️ Surname cannot be blank.');
...
const checkRole = () => {
    ...
    if (!isRequired(role)) {
        showError(roleEL, '⛔️ Role cannot be blank.');
...
const checkBranch = () => {
    ...
    if (!isRequired(ddbranch)) {
        showError(userbranchEl, '⛔️ Branch cannot be blank.');
    }
    else {
